...
const SET_PROJECT_DEPENDENCY_STATE_KEYS = new Set([
  "status",
  "projectPath",
  "projectType",
  "manifest",
...
const SET_PROJECT_DEPENDENCY_PLAN_KEYS = new Set([
  "status",
  "planSha256",
  "sourceManifest",
...
const SET_PROJECT_DEPENDENCY_PLAN_APPLIED_KEYS = new Set([
  "status",
  "planSha256",
  "targetManifest",
  "targetComponentsLock",
...
const SET_PROJECT_COMPONENTS_FOLDER_KEYS = new Set([
  "componentsPath",
  "componentCount",
  "fileCount",
]);
...
export function parseProjectDependencyStateResult(
  ...
  const dictValue = ensureExactRecord(
    value,
    SET_PROJECT_DEPENDENCY_STATE_KEYS,
...
export function parseProjectDependencyPlanResult(
  ...
  const dictValue = ensureExactRecord(
    value,
    SET_PROJECT_DEPENDENCY_PLAN_KEYS,
...
function parseProjectComponentsFolder(
  ...
  const dictValue = ensureExactRecord(
    value,
    SET_PROJECT_COMPONENTS_FOLDER_KEYS,
    sourceName,
  );
  return {
    componentsPath: ensureString(
      dictValue["componentsPath"],
      `${sourceName}.componentsPath`,
    ),
...
export function parseProjectDependencyPlanAppliedResult(
  ...
  const dictValue = ensureExactRecord(
    value,
    SET_PROJECT_DEPENDENCY_PLAN_APPLIED_KEYS,
...
export function parseProjectComponentsRepairedResult(
  ...
  const dictValue = ensureExactRecord(
    value,
    SET_PROJECT_COMPONENTS_REPAIRED_KEYS,
