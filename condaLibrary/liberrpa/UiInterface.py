...
def check_exists(
    ...
    Parameters:
        ...
        timeout: Maximum time allowed for the function to complete (in milliseconds). If timeout < 3000, it will be set to 3000.
        preExecutionDelay: Time to wait before performing the action (in milliseconds).
        postExecutionDelay: Time to wait after performing the action (in milliseconds).
...
def get_selection(
    ...
    Parameters:
        ...
        timeout: Maximum time allowed for the function to complete (in milliseconds). If timeout < 3000, it will be set to 3000. If the function is not completed within timeout, it will throw a UiTimeoutError.
        preExecutionDelay: Time to wait before performing the action (in milliseconds).
        postExecutionDelay: Time to wait after performing the action (in milliseconds).
