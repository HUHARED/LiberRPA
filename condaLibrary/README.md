...
Create a basic LiberRPA Python file template with imports, main(), and a direct-run entry point.
...
@overload
def read_row(excelObj: liberrpa.Excel.ExcelObj, sheet: ExcelSheet, startCell: ExcelCell, returnDisplayed: Literal[False] = False) -> list[ExcelCellValue]: ...
```
...
@overload
def read_column(excelObj: liberrpa.Excel.ExcelObj, sheet: ExcelSheet, startCell: ExcelCell, returnDisplayed: Literal[False] = False) -> list[ExcelCellValue]: ...
```
...
@overload
def read_range_list(excelObj: liberrpa.Excel.ExcelObj, sheet: ExcelSheet, startCell: ExcelCell, endCell: ExcelCell | None = None, returnDisplayed: Literal[False] = False) -> list[list[ExcelCellValue]]: ...
```
